/*
 * Vendored verbatim from libhybris
 * (hybris/include/hybris/camera/camera_compatibility_layer.h, commit
 * fbae2b1d542bc0cb7d958aa3301e2e4345237602) so camera_backend_hybris.c builds
 * without a libhybris dependency — the library itself is dlopen'd.
 *

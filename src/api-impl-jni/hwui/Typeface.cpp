...
#include <include/core/SkStream.h>  // Fot tests.
...
static minikin::FontStyle computeMinikinStyle(int weight, bool italic) {
    return minikin::FontStyle(std::clamp(weight, 1, 1000),
...
/* setRobotoTypefaceForTest removed: the default collection is built from
 * fontconfig in TypefaceCollection.cpp */
}  // namespace android

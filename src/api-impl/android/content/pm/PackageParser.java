...
public class PackageParser {
	...
	*/
	...
	private static boolean checkUseInstalledOrBlocked(int flags, PackageUserState state) {
		return (state.installed && !state.blocked) || (flags & PackageManager.GET_UNINSTALLED_PACKAGES) != 0;
	}
	...
	private Permission parsePermission(Package owner, Resources res,
		...
		if ((perm.info.protectionLevel & PermissionInfo.PROTECTION_MASK_FLAGS) != 0) {
			if ((perm.info.protectionLevel & PermissionInfo.PROTECTION_MASK_BASE) != PermissionInfo.PROTECTION_SIGNATURE) {

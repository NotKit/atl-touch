...
public abstract class BaseCanvas {
    ...
    public void drawColor(@ColorLong long color, @NonNull BlendMode mode) {
        throw new UnsupportedOperationException("ColorLong drawColor not supported yet");
    }
    ...
    private void throwIfHasHwFeaturesInSwMode(Shader shader) {
        /* hardware bitmaps and RuntimeShader are not supported here;
         * nothing to reject in an all-software canvas */
    }

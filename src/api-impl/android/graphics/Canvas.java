...
public class Canvas extends BaseCanvas {
    ...
    private static class NoImagePreloadHolder {
        public static final NativeAllocationRegistry sRegistry =
                ...
                Canvas.class.getClassLoader(), nGetNativeFinalizer(), 132);
    }
    ...
    public Canvas(long nativeCanvas) {
        this(nativeCanvas, true);
    }

    /**
     * @hide Wrap a native canvas without taking ownership: the caller (native
     * code, or a transfer such as RenderNode.end()) frees the ATLCanvas, so no
     * GC finalizer is registered.
     */
    public Canvas(long nativeCanvas, boolean ownsNativeCanvas) {
        if (nativeCanvas == 0) {
            throw new IllegalStateException();
        }
        mNativeCanvasWrapper = nativeCanvas;
        mFinalizer = ownsNativeCanvas
    ...
    */
    ...
    public void drawPatch(@NonNull NinePatch patch, @NonNull Rect dst, @Nullable Paint paint) {
        ...
        nDrawNinePatch(getNativeCanvasWrapper(), patch.getBitmap().getNativeInstance(),
                patch.mNativeChunk, dst.left, dst.top, dst.right, dst.bottom, nativePaint);
    }
    ...
    private static native void nDrawNinePatch(long canvas, long bitmap, long chunk,
            float dstLeft, float dstTop, float dstRight, float dstBottom, long paint);
     ...
     */
    public void drawRenderNode(@NonNull android.view.RenderNode renderNode) {

...
public class NinePatch {
	 ...
	 *
	 * ATL: not implemented (AOSP computes this natively for window shaping);
	 * returning null is a valid "no transparent region" answer.
	 *
	...
	/**
	 * Retrieves the padding encoded in the chunk into {@code outPadding}.
	 *
	 * ATL-specific helper for NinePatchDrawable; AOSP gets the padding from
	 * the BitmapFactory/ImageDecoder decode instead.
	 *
	 * @hide
	 */
	public void getPadding(Rect outPadding) {
		nativeGetPadding(mNativeChunk, outPadding);
	}

	/**
	 * Extracts the raw npTc chunk bytes from a compiled .9.png file, or null
	 * if the file has none.
	 *
	 * ATL-specific: replaces the ImageDecoder ninepatch path.
	 *
	 * @hide
	 */
	public static native byte[] nativeReadChunkFromFile(String path);
	...
	private static native void nativeGetPadding(long chunk, Rect outPadding);
}

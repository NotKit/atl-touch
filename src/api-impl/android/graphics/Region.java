...
public class Region implements Parcelable {
    ...
    */
        ...
        = new Parcelable.Creator<Region>() {
            ...
            * Rebuild a Region previously stored with writeToParcel().
            ...
            public Region createFromParcel(Parcel p) {
                // region parceling is not supported by the ATL Parcel implementation
                throw new UnsupportedOperationException("Region.CREATOR not supported");
            }
            @Override
    ...
    public void writeToParcel(Parcel p, int flags) {
        // region parceling is not supported by the ATL Parcel implementation
        throw new UnsupportedOperationException("Region.writeToParcel not supported");
    }

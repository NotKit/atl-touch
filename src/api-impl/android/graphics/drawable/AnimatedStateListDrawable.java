...
public class AnimatedStateListDrawable extends StateListDrawable {
	...
	public void inflate(Resources r, XmlPullParser parser, AttributeSet attrs, Theme theme)
		...
		/* AOSP also reads visible/variablePadding/constantSize/enterFadeDuration/
		 * exitFadeDuration/dither/autoMirrored here; our DrawableContainer does
		 * not implement any of those, so they are accepted and ignored. */
		a.recycle();
	...
	static class AnimatedStateListState extends StateListState {
		...
		AnimatedStateListState(AnimatedStateListState orig,
		                       AnimatedStateListDrawable owner, Resources res) {

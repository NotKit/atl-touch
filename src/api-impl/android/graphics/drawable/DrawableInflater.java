...
public final class DrawableInflater {
	 ...
	 * an override density.
	 */
	public @NonNull Drawable inflateFromXmlForDensity(@NonNull String name, @NonNull XmlPullParser parser,
	...
	private @Nullable Drawable inflateFromTag(@NonNull String name) {
		switch (name) {
			...
			// ATL: "animated-image" (AnimatedImageDrawable) needs ImageDecoder; unsupported
			default:
				return null;
		}
	}

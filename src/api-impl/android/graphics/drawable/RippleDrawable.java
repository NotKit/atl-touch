...
public class RippleDrawable extends LayerDrawable {
    ...
    /* ATL: the patterned (STYLE_PATTERNED) ripple needs RuntimeShader and the
     * RenderThread; only the solid software style is supported */
    ...
    private void endPatternedAnimations() {
        // ATL: patterned style not supported
    }
    ...
    /* ATL: STYLE_PATTERNED entry points reduced to no-ops (mRippleStyle is
     * always STYLE_SOLID) */

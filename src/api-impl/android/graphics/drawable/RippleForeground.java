 ...
 *
 * ATL: reduced to the software (UI-thread ValueAnimator) rendering path; the
 * AOSP RenderThread path (CanvasProperty/RenderNodeAnimator over a
 * RecordingCanvas) has no backend here.
 */

...
public class VectorDrawable extends Drawable {
	...
	private static class VPath {
		...
		/* AnimatorInflater's pathType animators produce PathParser.PathData values
		 * and set them through reflection; accept them alongside the node arrays. */
		@SuppressWarnings("unused")
		public void setPathData(PathParser.PathData data) {
			setPathData(data.getNodes());
		}
	}

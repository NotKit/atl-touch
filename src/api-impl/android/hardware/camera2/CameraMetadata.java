...
public abstract class CameraMetadata<TKey> {
	...
	public static final int BLACK_LEVEL_LOCK_OFF = 0;
	public static final int BLACK_LEVEL_LOCK_ON = 1;
	...
	public static final int CONTROL_AE_LOCK_AVAILABLE_FALSE = 0;
	public static final int CONTROL_AE_LOCK_AVAILABLE_TRUE = 1;
	public static final int CONTROL_AE_LOCK_OFF = 0;
	public static final int CONTROL_AE_LOCK_ON = 1;
	...
	public static final int CONTROL_AUTOFRAMING_AVAILABLE_FALSE = 0;
	public static final int CONTROL_AUTOFRAMING_AVAILABLE_TRUE = 1;
	...
	public static final int CONTROL_AWB_LOCK_AVAILABLE_FALSE = 0;
	public static final int CONTROL_AWB_LOCK_AVAILABLE_TRUE = 1;
	public static final int CONTROL_AWB_LOCK_OFF = 0;
	public static final int CONTROL_AWB_LOCK_ON = 1;
	...
	public static final int CONTROL_ENABLE_ZSL_FALSE = 0;
	public static final int CONTROL_ENABLE_ZSL_TRUE = 1;
	...
	public static final int DEPTH_AVAILABLE_DEPTH_STREAM_CONFIGURATIONS_INPUT = 1;
	public static final int DEPTH_AVAILABLE_DEPTH_STREAM_CONFIGURATIONS_OUTPUT = 0;
	public static final int DEPTH_DEPTH_IS_EXCLUSIVE_FALSE = 0;
	public static final int DEPTH_DEPTH_IS_EXCLUSIVE_TRUE = 1;
	...
	public static final int FLASH_INFO_AVAILABLE_FALSE = 0;
	public static final int FLASH_INFO_AVAILABLE_TRUE = 1;
	...
	public static final int HEIC_AVAILABLE_HEIC_STREAM_CONFIGURATIONS_INPUT = 1;
	public static final int HEIC_AVAILABLE_HEIC_STREAM_CONFIGURATIONS_OUTPUT = 0;
	...
	public static final int JPEGR_AVAILABLE_JPEG_R_STREAM_CONFIGURATIONS_INPUT = 1;
	public static final int JPEGR_AVAILABLE_JPEG_R_STREAM_CONFIGURATIONS_OUTPUT = 0;
	...
	public static final int REQUEST_AVAILABLE_COLOR_SPACE_PROFILES_MAP_BT2020_HLG = 16;
	public static final int REQUEST_AVAILABLE_COLOR_SPACE_PROFILES_MAP_DISPLAY_P3 = 7;
	public static final int REQUEST_AVAILABLE_COLOR_SPACE_PROFILES_MAP_SRGB = 0;
	...
	public static final int SCALER_AVAILABLE_RECOMMENDED_STREAM_CONFIGURATIONS_RAW = 5;
	public static final int SCALER_AVAILABLE_RECOMMENDED_STREAM_CONFIGURATIONS_ZSL = 4;
	...
	public static final int SCALER_MULTI_RESOLUTION_STREAM_SUPPORTED_FALSE = 0;
	public static final int SCALER_MULTI_RESOLUTION_STREAM_SUPPORTED_TRUE = 1;
	...
	public static final int SENSOR_INFO_LENS_SHADING_APPLIED_FALSE = 0;
	public static final int SENSOR_INFO_LENS_SHADING_APPLIED_TRUE = 1;
	...
	public static final int SENSOR_RAW_BINNING_FACTOR_USED_FALSE = 1;
	public static final int SENSOR_RAW_BINNING_FACTOR_USED_TRUE = 0;
	...
	public static final int STATISTICS_HOT_PIXEL_MAP_MODE_OFF = 0;
	public static final int STATISTICS_HOT_PIXEL_MAP_MODE_ON = 1;
